...
```bash
python ~/.agent/skills/latex-formatting/scripts/latex_checker.py paper/main.tex --venue neurips --check-anon
```
...
```bash
python ~/.agent/skills/latex-formatting/scripts/clean_latex.py \
...
```bash
python ~/.agent/skills/latex-formatting/scripts/latex_checker.py paper/main.tex --venue neurips --fix
```
...
- Venue specs, project structure, packages, commands: `~/.agent/skills/latex-formatting/references/venue-templates.md`
