...
- 4-round code review prompts: `~/.agent/skills/data-analysis/references/review-prompts.md`

## Scripts

### Statistical summary and comparison
```bash
python ~/.agent/skills/data-analysis/scripts/stat_summary.py --input results.csv --compare method --metric accuracy --output summary.json
python ~/.agent/skills/data-analysis/scripts/stat_summary.py --input results.csv --describe
```
...
### Format p-values
```bash
python ~/.agent/skills/data-analysis/scripts/format_pvalue.py --values "0.001 0.05 0.23" --format stars
python ~/.agent/skills/data-analysis/scripts/format_pvalue.py --csv results.csv --column pvalue --format latex
```
