...
- Section writing tips: `~/.agent/skills/paper-writing-section/references/section-tips.md`
- Refinement prompts and error checklist: `~/.agent/skills/paper-writing-section/references/refinement-prompts.md`
